...
Adicionalmente se incluyen cursos de Kaggle Learn de Machine Learning (Intro to Machine Learning, Intermediate Machine Learning, Intro to Deep Learning, Computer Vision, Feature Engieering, Time Series y Machine Learning Explainaility) para ampliar este repositorio.
...
## ⭐ Cursos adicionales de ML certificados de Kaggle Learn

### 🪐 Intro to Machine Learning 

Curso introductorio enfocado en los fundamentos del Machine Learning utilizando Python y scikit-learn. A través de un caso práctico de predicción de precios de viviendas, se abordan conceptos clave como exploración de datos, entrenamiento de modelos, validación, underfitting y overfitting, y el uso de algoritmos como Decision Trees y Random Forests para mejorar el desempeño de los modelos.
...
### 🔥 Machine Learning Explainaility
...
Estudiante de Ingeniería en ciencias de la computación, *Machine Learning*, Dr. Graciela Maria de Jesus Ramirez Alonso
